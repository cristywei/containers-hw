...
class NormalizedStr:
    ...
    equal *semantically*, but not equal *representationally*.
    ...
    def __repr__(self):
        ...
        code that can be substituted directly into
        the python interpreter
        to reproduce an equivalent object.
        '''
        return "NormalizedStr('" + self.text + "', '" + self.form + "')"
    ...
    def __contains__(self, substr):
        ...
        '''
        self.normsub = unicodedata.normalize(self.form, substr)
        return self.normsub in self.text
    ...
    def __add__(self, b):
        ...
        '''
        self.add = str(self.text) + str(b)
        self.normadd = unicodedata.normalize(self.form, self.add)
        return NormalizedStr(self.normadd)
...
class NormalizedStrIter:
    '''
    Iterator helper class for the NormalizedStr class
    '''
